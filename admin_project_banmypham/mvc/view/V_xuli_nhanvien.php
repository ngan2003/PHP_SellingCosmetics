    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 menu-right">
                ...
                <form action="?controller=xuli_nhanvien&method=edit&id_user=<?php echo $_GET['id_user'] ?>"
                    method="post" style="text-align: center;"><br>

                    <h4><i class="fa-solid fa-user-large" style="margin-right:6px;"></i>Tài khoản:
                        <?php echo $data_nhanvien[0]['username'] ?></h4><br>


                    <input type="password" name="password" class=" " placeholder="Mật khẩu"
                        value="<?php echo $data_nhanvien[0]['password'] ?>"><br><br>
                    ...
                    <input type="text" name="full_name" class=" " placeholder="Họ và tên"
                        value="<?php echo $data_nhanvien[0]['name'] ?>"><br><br>
